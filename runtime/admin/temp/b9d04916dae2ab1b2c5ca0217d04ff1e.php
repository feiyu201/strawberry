<?php /*a:1:{s:53:"E:\phpstudy\WWW\okadmin\app\admin\view\admin\add.html";i:1600760613;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<script>
	...
	layui.use(["element", "form", "laydate", "okLayer", "okUtils"], function () {
		...
		form.on("submit(add)", function (data) {
			okUtils.ajax("<?php echo url('add'); ?>", "post", data.field, true).done(function (response) {
