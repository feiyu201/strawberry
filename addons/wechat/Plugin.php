	...
	public function install()
	{
		$menu = [
            [
                ...
                'ismenu'  => 1,//是否是菜单
                'sublist' => [
                    ['name' => 'addons/wechat/wx/index', 'title' => '查看', 'ismenu' => 1],
                    ['name' => 'addons/wechat/wx/add', 'title' => '添加', 'ismenu' => 0],
                    ['name' => 'addons/wechat/wx/detail', 'title' => '详情', 'ismenu' => 0],
                ]
            ]
        ];
        Menu::create($menu);
