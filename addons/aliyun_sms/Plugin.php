...
{
    const NAME = 'aliyun_sms';
    const TITLE = '阿里云短信';
    const DESCRIPTION = '一款阿里云短信插件';
    const ICON = 'fa-list';
    const SUBLIST_NAME = 'addons/aliyun_sms/Index/';
    ...
    public function install()
    {
        $menu = [
            [
                ...
                'ismenu'  => 1,//是否是菜单
                'sublist' => [
                    ['name' => SELF::SUBLIST_NAME . 'index', 'title' => '短信发送日志', 'ismenu' => 1],
