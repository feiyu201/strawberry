...
use addons\qiniu_storage\common\library\storage\engine\Server;
/**
 * 七牛云存储引擎
 * Class Qiniu
...
class Qiniu extends Server
{
    ...
    public function upload()
    {
        ...
        list($result, $error) = $uploadMgr->putFile($token, $this->getFileName(), $realPath);
